  ...
  fetch("/admin/_api/v1/stats")
    ...
    .then((data) => {
      ...
      document.getElementById("memory-details").textContent =
        `${formatBytes(data.memory.usedMem * 1024 * 1024 * 1024)} of ${formatBytes(data.memory.totalMem * 1024 * 1024 * 1024)}`;
      ...
      document.getElementById("storage-details").textContent =
        `${formatBytes(data.disk.usedDisk * 1024 * 1024 * 1024 * 1024)} of ${formatBytes(data.disk.totalDisk * 1024 * 1024 * 1024 * 1024)}`;
